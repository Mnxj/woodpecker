...
window.$docsify = window.$docsify || {},
    window.$docsify.plugins = [function (n, i) {
        n.ready((function () {
            window.Valine
        }
        )),
            n.mounted((function () {
                ...
                i.id = "vcomments";
                n.getNode("#main");
                i.style = "max-width: 80% !important; margin: 0 auto 20px;",
                    n.appendTo(n.find(".content"), i)
            }
            )),
            n.doneEach((function () {
                const key = i.config.key, iv = i.config.iv;
                const encrypted = ''
                ...
                const path = "full" === i.config.Valine.docPath ? location.pathname + location.hash.replace(/\?.+/, "") : location.hash.replace(/\?.+/, "")
                new Valine({
